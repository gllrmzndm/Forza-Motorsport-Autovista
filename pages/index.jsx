  ...
  return (
    <div className="z-0 border-2 border-emerald-300 overflow-hidden static w-full">
      <div className="player-wrapper pointer-events-none aspect-video object-cover relative border-2 border-orange-500 h-screen md:h-full w-screen">
        <iframe width="100%" height="100%" loop="loop" src="https://www.youtube.com/embed/oB5vg1CniJc?autoplay=1&mute=1&playlist=oB5vg1CniJc&loop=1" title="YouTube video player" frameorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture loop;" autoplay="true" allowfullscreen></iframe>
      </div>
    </div>
  )
}
